...
- Fix issue with Button (issue #64)
...
- _Breaking Change_: depericated button_result in UpdateReturnData
...
- fixed naming issue in floating_button(Example: demo/pages/input_page/**init**.py, demo/pages/input_page/row_seven/view.py)

# 0.6.4

- fix naming issue in floating_button (Example: demo/pages/input_page/**init**.py, demo/pages/input_page/row_seven/view.py)

# 0.6.3

- added TargetAttribute in button
- added floating_button_url in page (Example: demo/pages/input_page/**init**.py)
