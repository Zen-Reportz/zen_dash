...
async def d3():
    return i.ReturnData(type=i.InstanceType.SLIDER,
                        ...
                        slider_data=i.SliderData(name="slider_example", min=0, max=100, step=10))
...
async def d3():
    return i.ReturnData(type=i.InstanceType.SLIDER,
                        ...
                        slider_data=i.SliderData(name="slider_example", min=0, max=100, step=10, vertical=True))
...
async def d3():
    return i.ReturnData(type=i.InstanceType.SLIDER,
                        ...
                        slider_data=i.SliderData(name="slider_example", min=0, max=100, step=10, invert=True))
...
async def d3():
    return i.ReturnData(type=i.InstanceType.SLIDER,
                        ...
                        slider_data=i.SliderData(name="slider_example", min=0, max=100, step=10, vertical=True, invert=True))
