...
async def prf():
    d = [i.ReturnData(type=i.InstanceType.DATE, date_data=i.DateTimeData(label="Select Date", name="single_date", first_date="2020-11-24"), reactive=i.ReactiveData(
        ids=['multi_date']
    )),
        i.ReturnData(type=i.InstanceType.DATE, date_data=i.DateTimeData(label="Select Date", name="single_date", first_date="2023-11-24"), reactive=i.ReactiveData(
            ids=['multi_date']
        ))]
